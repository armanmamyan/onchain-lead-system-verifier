...
const PartnerPage = ({ partnerName }: { partnerName: string }) => {
          ...
          <div className="max-w-2xl mx-auto space-y-8">
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground max-w-xl mx-auto">
                Your credentials have been verified. You now have access to
                ...
                <div className="bg-gradient-to-r from-green-600 to-emerald-600 text-white p-6 rounded-lg shadow-md">
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-center gap-3">
                      ...
                      <span>
                        $20 trading credit bonus applied to your account
                      </span>
                    </li>
                    <li className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0">
                ...
                <CardContent className="pt-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Your $20 trading credit has been automatically added to
                        your account
                      </p>
                    </div>
                  </div>
                ...
                <CardContent className="pt-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        24/7 VIP customer support is now available for your
                        account
                      </p>
                    </div>
                  </div>
            ...
            <div className="text-center text-xs text-muted-foreground">
              <p>
                Your verified status was confirmed using zero-knowledge proofs.
